...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void setInitialDisplaySize(Display display, int width, int height) {
        ...
        if (!mHasSystemNavBar) {
            ...
            mHasNavigationBar = SystemProperties.getBoolean("persist.tweak.show_navi_bar", mHasNavigationBar);
            Log.i("[PhoneWindowManager:DBG]", "mHasNavigationBar=" + mHasNavigationBar);
